...
import { insertInlineChipViaSlashMenu, insertInlineChipViaHash } from '../../../helpers/editorHelpers';
...
describe('Undo (Ctrl+Z)', () => {
  ...
  it('undoes S chip inserted via slash menu — chip is gone, raw text may remain', async () => {
    renderEditor();
  ...
  it('undoes S chip inserted via ### hash — chip is gone, raw text may remain', async () => {
    renderEditor();
